  ...
  return (
    <SidebarProvider>
       <div className={cn(
        ...
        activeView === 'tickets' ? "grid-cols-1 lg:grid-cols-[280px_1fr_320px]" : "grid-cols-1 lg:grid-cols-[280px_1fr]"
      )}>
        <Sidebar variant="inset" className="w-full bg-card hidden lg:flex flex-col py-6">
